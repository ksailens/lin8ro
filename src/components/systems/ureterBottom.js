...
export const UreterBottom = observer(() => {
  ...
  function handleSaveCoefficients() {
    coefficientStore.setCurrentCoefficients(coefficients, Systems.ureterBottom);
  }

  function handleReset() {
    coefficientStore.resetCurrentCoefficients(Systems.ureterBottom);
  }

  function handleResetPrevious() {
    coefficientStore.resetPreviousCoefficients(Systems.ureterBottom);
  }
    ...
    <div className="container">
      <div>
        ...
        <p className="ps-4">
          ...
          X<sub>2</sub> - место локализации<br/>
      ...
      <div className="mt-3">
        ...
        <button
          ...
          disabled={!coefficientStore.isCoefficientsChanged[Systems.ureterBottom]}
          onClick={handleReset}
        >
          Сбросить
        </button>
